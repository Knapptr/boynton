...
module.exports = class CabinSession {
	...
	async getCampers() {
		const query = `SELECT age, cabins.name,first_name,last_name,weeks.title,camper_id,camper_weeks.week_id,camper_weeks.id,camper_weeks.cabin_session_id, camper_weeks.day_camp 
		FROM  camper_weeks 
