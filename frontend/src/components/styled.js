...
const DialogBoxBox = styled.div(({ scrollable, full }) => [tw`h-full sm:h-auto w-full bg-coolGray-100 p-5 md:w-11/12 lg:w-1/2 my-4 rounded shadow-lg  relative flex flex-col py-8 `, scrollable && tw`overflow-auto`, full && tw`flex-grow`])
